    ...
    <>
      ...
      >
        ...
        <div className="bg-[#2d2d2d] px-4 py-3 flex items-center gap-4">
          ...
          <div className="text-[#c0c0c0] text-sm">yamlyeti@bergman.local:~/resume</div>
        </div>

        {/* Content */}
        <div className="p-8">
          <div className="text-terminal-green mb-6">
            <span className="text-terminal-cyan">$</span> cat resume.md
          </div>

          <div className="text-[#c0c0c0] space-y-6">
            <h1 className="text-3xl text-terminal-yellow mb-4">Josh Bergman - Resume</h1>
            
            <section>
              <h2 className="text-xl text-terminal-cyan mb-2">Experience</h2>
              <p className="ml-4">Coming soon...</p>
            </section>

            <section>
              <h2 className="text-xl text-terminal-cyan mb-2">Education</h2>
              <p className="ml-4">Coming soon...</p>
            </section>

            <section>
              <h2 className="text-xl text-terminal-cyan mb-2">Certifications</h2>
              <p className="ml-4">Coming soon...</p>
            </section>
